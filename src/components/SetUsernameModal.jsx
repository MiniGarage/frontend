...
export default function SetUsernameModal({ isOpen, onClose, onSubmit }) {
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 border-2 border-purple-500 rounded-2xl p-8 max-w-md w-full shadow-2xl my-8 max-h-[90vh] overflow-y-auto">
        {/* Header */}
