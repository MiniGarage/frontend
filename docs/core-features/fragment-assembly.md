...
<table data-card-size="large" data-view="cards"><thead><tr><th>Fragment</th><th>Description</th><th>Fragment ID</th></tr></thead><tbody><tr><td><strong>Chassis</strong></td><td>Main structural frame</td><td>0</td></tr><tr><td><strong>Wheels</strong></td><td>Rolling system</td><td>1</td></tr><tr><td><strong>Engine</strong></td><td>Power unit</td><td>2</td></tr><tr><td><strong>Body</strong></td><td>Exterior shell</td><td>3</td></tr><tr><td><strong>Interior</strong></td><td>Cabin &#x26; details</td><td>4</td></tr></tbody></table>
...
![Assembly Flow](../.gitbook/assets/craftingflow.png)

⚡ Gasless Crafting Fragment assembly is completely gasless.
...
🎯 Rarity Preservation Fragment rarity is preserved during assembly.

Fragment Tier Crafted Car Common Common Car Rare Rare Car Epic Epic Car Legendary Legendary Car A Legendary car can only be crafted from Legendary fragments.

🧠 Why This Matters Fragments solve the biggest problem in gacha games:

Traditional Gacha Endless bad luck

No visible progress

High frustration

MiniGarage Every spin adds progress
...
📝 On-Chain Enforcement Fragment logic is enforced by smart contracts.
...
function burnForAssembly( address user, uint256\[] memory ids, uint256\[] memory amounts ) external onlyMinter; 🔁 Progression Loop Summary Gacha → Fragment → Trade → Assemble → Full Car NFT Fragments turn randomness into progression.

➡️ What’s Next? After assembling a full car, players can:
